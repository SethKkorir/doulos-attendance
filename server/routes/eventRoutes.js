...
import { getEvents, getAllEventsAdmin, createEvent, updateEvent, deleteEvent, getCalendarEvents } from '../controllers/eventController.js';
import { verifyToken, verifyAdmin } from '../middleware/authMiddleware.js';

const router = express.Router();

router.get('/calendar', getCalendarEvents);
router.post('/calendar', verifyToken, verifyAdmin, createEvent);
